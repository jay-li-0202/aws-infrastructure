module "cors-adressen1" {
  ...
  api_resource_id = aws_api_gateway_resource.adressen_root1.id
}
...
module "cors-adressen2" {
  source          = "../cors"
  api_id          = var.rest_api_id
  api_resource_id = aws_api_gateway_resource.adressen_root2.id
}
...
module "cors-adressen3" {
  source          = "../cors"
  api_id          = var.rest_api_id
  api_resource_id = aws_api_gateway_resource.adressen_root3.id
}
...
resource "aws_api_gateway_integration" "get-adressen-integration1" {
  ...
  uri = "http://$${stageVariables.baseHost}/v1/adressen/"
...
resource "aws_api_gateway_integration" "get-adressen-integration2" {
  ...
  uri = "http://$${stageVariables.baseHost}/v1/adressen.json"
...
resource "aws_api_gateway_integration" "get-adressen-integration3" {
  ...
  uri = "http://$${stageVariables.baseHost}/v1/adressen.xml"
