...
module "building-registry" {
  ...
  api_memory        = 1024
  api_replicas      = 2
  legacy_api_image  = "${var.aws_account_id}.dkr.ecr.eu-west-1.amazonaws.com/building-registry/api-legacy:1.5.2"
  import_api_image  = "${var.aws_account_id}.dkr.ecr.eu-west-1.amazonaws.com/building-registry/api-crab-import:1.5.2"
  extract_api_image = "${var.aws_account_id}.dkr.ecr.eu-west-1.amazonaws.com/building-registry/api-extract:1.5.2"

  projections_cpu      = 512
  projections_memory   = 1024
  projections_replicas = 1
  projections_image    = "${var.aws_account_id}.dkr.ecr.eu-west-1.amazonaws.com/building-registry/projector:1.5.2"
  syndication_image    = "${var.aws_account_id}.dkr.ecr.eu-west-1.amazonaws.com/building-registry/projections-syndication:1.5.2"
