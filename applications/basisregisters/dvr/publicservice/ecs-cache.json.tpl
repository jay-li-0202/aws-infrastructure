[
  {
    ...
    "environment" : [
      ...
      { "name": "Redis__ClientName", "value": "Redis - PublicService Populator" },

      { "name": "ApiBaseAddress", "value": "http://${disco_namespace}-publicservice-registry-api.${disco_zone_name}:8002" },
