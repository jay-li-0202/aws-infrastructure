[
...

  {
    ...
    "environment" : [
      ...
      { "name": "Naamruimte", "value": "https://data.vlaanderen.be/id/dienstverlening" },

      { "name": "DetailUrl", "value": "https://api.${public_zone_name}/v1/dienstverleningen/{0}" },
      { "name": "VolgendeUrl", "value": "https://api.${public_zone_name}/v1/dienstverleningen?offset={0}&limit={1}" },

      { "name": "Syndication__Category", "value": "https://data.vlaanderen.be/ns/dienstverlening" },
      { "name": "Syndication__Id", "value": "https://api.${public_zone_name}/v1/feeds/dienstverleningen.atom" },
      { "name": "Syndication__Self", "value": "https://api.${public_zone_name}/syndication/feed/publicservice.atom" },
      { "name": "Syndication__NextUri", "value": "https://api.${public_zone_name}/v1/feeds/dienstverleningen.atom?offset={0}&limit={1}" },
