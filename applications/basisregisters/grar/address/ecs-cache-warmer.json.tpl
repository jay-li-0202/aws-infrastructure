[
  {
    "name": "${app_name}",
    "image": "${cache_warmer_image}",
    "essential": true,
    "networkMode": "awsvpc",
    "environment" : [
      { "name": "API_URI", "value": "http://${disco_namespace}-address-registry-api.${disco_zone_name}:5002/v1/adresmatch?straatnaam=steenbrugsestraat&huisnummer=37&postcode=8210" },
