[
  {
    ...
    "environment" : [
      ...
      { "name": "Redis__ClientName", "value": "Redis - Municipality Populator" },

      { "name": "ApiBaseAddress", "value": "http://${disco_namespace}-municipality-registry-api.${disco_zone_name}:2002" },
